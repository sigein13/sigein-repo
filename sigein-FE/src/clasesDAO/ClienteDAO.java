...
public class ClienteDAO extends BaseDAO{
	...
	private PreferenciaDAO preferenciaCliente;

	public ClienteDAO(int idCliente,String nombreCliente, String correoElectronicoCliente,
			String apellidoCliente, int telefonoCliente, PreferenciaDAO preferencia) {
		super();
	...
	public PreferenciaDAO getPreferenciaCliente() {
		return preferenciaCliente;
	}



	public void setPreferenciaCliente(PreferenciaDAO preferenciaCliente) {
